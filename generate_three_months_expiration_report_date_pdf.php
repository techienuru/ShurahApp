...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        // Center the title
        $title = 'Products within 3 months to expiration';
...
$display_heading = array('prod_id'=>'Product ID', 'prod_name'=>'Product Name', 'category_name'=>'Category Name', 'expiration'=>'Expiry Date', 'days_remaining'=>'Days Remaining');
