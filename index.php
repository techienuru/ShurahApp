    ...
    <div class="header_section">
      <div class="header_left">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <div class="logo"><a href="index.php"><img src="images/shurah_logo1.png"></a></div>
        ...
        <div class="banner_main">
          <!--<h1 class="banner_taital">School management <br>system</h1>
          <p class="banner_text">Tracks multiple sales and inventory management </p>
          <div class="btn_main">
            <div class="more_bt"><a href="#">Read More </a></div>
            <div class="contact_bt"><a href="#">Contact Us</a></div>-->
          </div>
        </div>
        <div class="header_right" style="margin-top:250px;">
        <img src="images/shurah_logo.png" class="banner_img">
      </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-sm-6">
            ...
            <div class="location_text"><img src="images/map-icon.png"><span class="padding_left_15">Kaduna</span></div>
            <div class="location_text"><img src="images/call-icon.png"><span class="padding_left_15"> +234 7050551517</span></div>
            <div class="location_text"><img src="images/mail-icon.png"><span class="padding_left_15">pabeadsypder@gmail.com</span></div>
          </div>
          <div class="col-lg-3 col-sm-6">
        ...
        <!--<div class="copyright_section">
          <div class="copyright_text">Copyright 2019 All Right Reserved By <a href="#">Pabead Systems</a></div>
        </div>
