<div class="container" >
         <div class="box" style="width: 100%;">
             <div class="row" style="margin-left: 1px; margin-right: -2%; margin-top: 2%;">      
                  ...
                  <div class="alert alert-secondary" style="width: 20%"><h5 class="text-center"><strong>Total Users</strong></h5><h5 class="text-center" ><center><div class="icon"><i class="fa fa-user-friends fa-2x"></i></div></center><?php echo number_format($users) ; ?></h5></div>
                 <div class="alert alert-success" style="width: 19%"><h5 class="text-center"><strong>Products</strong></h5><h5 class="text-center" ><center><div class="icon"><i class="fa fa-box fa-2x"></i></div></center><?php echo number_format($total_products) ; ?></h5></div>
                 <div class="alert alert-secondary" style="width: 19%"><h5 class="text-center"><strong>Re-Stock Level</strong></h5><h5 class="text-center" ><center><div class="icon"><i class="fa fa-sync fa-2x"></i></div></center><?php echo  number_format($re_stock) ; ?></h5></div>
                 <div class="alert alert-success" style="width: 19%"><h5 class="text-center"><strong>Daily Expense</strong></h5><h5 class="text-center" ><center><div class="icon"><i class="fa fa-money-bill-wave fa-2x"></i></div></center><?php echo "₦ ". number_format($total_daily_expense) ; ?></h5></div>                                     
         	 </div>
		</div>
		<div class="box" style="width: 100%; margin-top: -5px;">
			 <div class="row" style="margin-left: 1px; margin-right: -2%; margin-top: 2%;">      
                  <div class="alert alert-success" style="width: 20%; margin-left: -8px;"><h5 class="text-center"><strong>Product with 3 Months to expiration</strong></h5><h5 class="text-center"><center><div class="icon"><i class="fa fa-box fa-2x"></i></div></center><?php echo $total_product_with_3_months_expiration;  ?></h5></div>           
