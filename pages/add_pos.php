    ...
    <div class="team_section layout_padding"  style="margin-top: -100px">
      <div class="">
        <h1 class="what_taital">Add POS</h1>
        <p class="what_text_1"> </p>

        <div class="container">
            <h1 class="text-center"><b> </b></h1>
            <div class="box">
                <h3 class="text-center"><b>POS Details</b></h3>
                <hr>
                <form action="dashboard.php?page=pages/process_add_pos" method="post">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <b><label>POS ID :</label></b>
                                <input class="form-control" type="text" name="pos_id" value="<?php echo $rnd ; ?> " readonly required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <b><label>POS Name :</label></b>
                                <input class="form-control" type="text" name="pos_name" placeholder="Enter POS Name" required>
                            </div>
                        </div>               
                    </div>
                     <hr>
