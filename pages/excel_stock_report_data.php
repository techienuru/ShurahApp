      ...
      <div class="">
        ...
        <div class="container">
            ...
            <div class="box">
                ...
                <hr>
                <form action="pages/excel_stock_report_data_with_date_range.php" method="post">
                      <div class="row">
                        <div class="col-3">
                            <div class="form-group">
                                <b><label>From :</label></b>
                                <input class="form-control" type="date" style="font-size: 12px;" name="date1" format="yyyy-mm-dd" value="<?php echo $start_date; ?>" required>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group">
