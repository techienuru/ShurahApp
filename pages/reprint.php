...
<div class="container" style="margin-top: 15px;">
		...
		<div class="row" style="margin: 0 auto; padding: 10px; width: 365px; font-weight: normal;">
		  <div style="width: 110%;">
				...
				<div style="display: flex; justify-content: center;">
					<h2 style="border-bottom: 2px solid;"><strong>Reprinted-Reciept</strong></h2>
				</div>
					...
					<div style="display: flex; justify-content: center;">
						<table cellspacing="0" style="font-family: arial; font-size: 13px;text-align:center;" width="100%">
					<thead>
						<tr>
					...
					<tbody>
						<tr>
							<!--<td style="font-size: 12px; text-align: left" colspan='2'>Attendant: <strong><?php echo " ". $attendant ;?></strong></td>-->
							
						</tr>
						<tr>
							<td style="font-size: 12px; text-align: left" colspan='2'> Status<strong> Reprinted</strong></td>
							<td style="font-size: 12px; text-align: left">Printed On : <strong><?php echo " ". $date; ?></strong>
						</td>
						</tr>
					</tbody>					
						</table>
    ...
    <div style="width: 375px; float: center; height: 250px;">
			<div style="width: 100%">
				<table  cellspacing="0" style="font-family: arial; font-size: 14px;text-align:left;" width="100%">
					<thead>
						<tr>
