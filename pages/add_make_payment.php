      ...
      <div class="">
        ...
        <div class="container">
            ...
            <div class="box">
                ...
                <hr>
                <form action="dashboard.php?page=pages/add_make_payment2" method="post">
                    <div class="row">
                        <input class="form-control" type="hidden" name="invoice" value="<?php echo $receiptNumber ; ?> " readonly required>
                        <div class="col-4">
