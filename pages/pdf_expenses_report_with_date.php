        ...
        <div class="team_section layout_padding">
          ...
          <div class="">
            <h1 class="what_taital">Expenses Report PDF format</h1>
            <p class="what_text_1"> </p>

            <div class="container">
                <h1 class="text-center"><b> </b></h1>
                <div class="box">
                    <h3 class="text-center"><b>Expenses Report Details</b></h3>
                    <hr>
                    <form action="generate_expenses_report_date_pdf.php" method="post">
                      <div class="row">
                        <div class="col-3">
