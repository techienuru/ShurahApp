    ...
    <div class="team_section layout_padding"  style="margin-top: -100px">
      <div class="">
        <h1 class="what_taital">Credit Sales Invoice</h1>
        <p class="what_text_1"> </p>

        <div class="container">
            <h1 class="text-center"><b> </b></h1>
            <div class="box">
                <h3 class="text-center"><b>Invoice Details</b></h3>
                <hr>
                <form action="dashboard.php?page=pages/client_invoice_preview" method="post">
                    <div class="row">
                        <!--<input class="form-control" type="hidden" name="invoice" value="<?php echo "NTC-".$receiptNumber ; ?> " readonly required>-->
                        <div class="col-4">
                            <div class="form-group">
                                <b><label>Invoice Number :</label></b>
                                <input class="form-control" type="text" name="invoice" placeholder="Enter Invoice" required>
                            </div>
                        </div>               
                    </div>
                     <hr>
