...
<?php
        ...
        header("Location: dashboard.php?page=pages/add_credit_details&name={$name}&debit={$total_debit}&credit={$total_credit}&balance={$balance}&client_id={$client_id}&invoice={$invoice}");
