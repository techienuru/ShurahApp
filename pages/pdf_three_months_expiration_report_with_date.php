          ...
          <div class="">
            ...
            <div class="container">
                ...
                <div class="box">
                    ...
                    <hr>
                    <form action="generate_three_months_expiration_report_date_pdf.php" method="post">
                      <div class="row">
                        <div class="col-3">
                            <div class="form-group">
                                <b><label>From :</label></b>
                                <input class="form-control" type="date" style="font-size: 12px;" name="start_date" format="yyyy-mm-dd" value="<?php echo $start_date; ?>" readonly required>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group">
