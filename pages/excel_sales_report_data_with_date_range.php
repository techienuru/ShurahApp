...
$sql_query = "SELECT a.date AS DATE, a.invoice AS INVOICE_NO, a.cash AS CASH, a.pos AS POS, a.transfer AS TRANSFER, a.bank AS BANK,a.pos_medium AS POS_MEDIUM, a.total_payment AS TOTAL, a.balance AS BALANCE, a.client_name AS CLIENT_NAME FROM sales a WHERE a.date BETWEEN '".date('Y-m-d', strtotime($_POST['date1']))."' AND '".date('Y-m-d', strtotime($_POST['date2']))."'";
...
//export
	...
	$filename = $company_name."_sales_report_".date('Y-m-d') . ".xls";			
