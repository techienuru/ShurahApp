    ...
    <div class="team_section layout_padding"  style="margin-top: -100px">
      <div class="">
        <h1 class="what_taital">Add Bank</h1>
        ...
        <div class="container">
            ...
            <div class="box">
                ...
                <hr>
                <form action="dashboard.php?page=pages/process_add_bank" method="post">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <b><label>Bank ID :</label></b>
                                <input class="form-control" type="text" name="bank_id" value="<?php echo $rnd ; ?> " readonly required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
