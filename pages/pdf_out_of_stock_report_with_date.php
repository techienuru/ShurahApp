 ...
 // to get the first date from product as the startdate
        ...
        <div class="team_section layout_padding">
          ...
          <div class="">
            <h1 class="what_taital">Out of Stock Report PDF format</h1>
            <p class="what_text_1"> </p>

            <div class="container">
                <h1 class="text-center"><b> </b></h1>
                <div class="box">
                    <h3 class="text-center"><b>Out of Stock Report Details</b></h3>
                    <hr>
                    <form action="generate_out_of_stock_report_date_pdf.php" method="post">
                      <div class="row">
                        <div class="col-3">
