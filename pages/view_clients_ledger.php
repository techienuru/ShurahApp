    ...
    <div class="team_section layout_padding" style="margin-top: -100px">
      <div class="">
        <h1 class="what_taital">View Clients Balance</h1>
        ...
        <center>
            ...
            <thead>
                ...
                <th style="font-size: 12px;">Total Debit</th>
                <th style="font-size: 12px;">Total Credit</th>
...
$(document).ready(function() {
    $('#contact-detail').dataTable({
        ...
        "processing": true,
        "serverSide": true,
        "ajax": "pages/view_clients_ledger_server.php"
    } );
} );
</script>
