    ...
    <div class="team_section layout_padding">
      <div class="">
        <h1 class="what_taital">Download stock report in excel format</h1>
        <p class="what_text_1"> </p>

        <div class="container">
            <h1 class="text-center"><b> </b></h1>
            <div class="box">
                <h3 class="text-center"><b>Stock Details</b></h3>
                <hr>
                <form action="pages/excel_re_order_report_data_with_date_range.php" method="post">
                    <div class="row">
                    <div class="form-group">
                        <a href=""><button class="btn btn-primary" name="generate" id="generate" style="margin-left: 3px; margin-top: 35px;"><i class="fa fa-download"></i> Download report with date range</button></a>
                    </div>
                    </div>
